...
# ─── Tabs ──────────────────────────────────────────────────────────────────────
tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["📈 OVERVIEW", "🧮 SIMULATOR", "🛡 HEALTH RADAR", "⚖️ ANALYTICS", "🔁 REBALANCER", "❓ FAQS"])
    ...
    for idx, (vname, vdata) in enumerate(VAULTS.items()):
        ...
        fig_g = go.Figure(go.Indicator(
            ...
            gauge={
                ...
                "bordercolor": "#131B25",
                "steps": [
                    {"range": [1.0, 1.1], "color": "#FF3D5A20"},
                    {"range": [1.1, 1.5], "color": "#FF7A2F20"},
                    {"range": [1.5, 2.0], "color": "#E8A02020"},
                    {"range": [2.0, 3.0], "color": "#EDD97A20"},
                    {"range": [3.0, 5.0], "color": "#00FFB220"},
                ],
